...
public class Vector3f {
	 ...
	 * @param vector3f The vector to copy.
	 */
	 ...
	 * @param vector3f Vector to add to this vector.
	 * @return this
	 */
	 ...
	 * @param vector3f Vector to subtract from this vector.
	 * @return this
	 */
	...
	/**
	 * Multiply this.x, this.y, and this.z by x, y, and z. Note that if you want to leave
	 ...
	 * @param z The value to multiply Z by.
	 * @return this
	 */
	 ...
	 * @param vector3f The vector to multiply this vector by.
	 * @return this
	 */
	...
	/**
	 * Divide this.x, this.y, and this.z by x, y, and z. Note that if you want to leave
	 * values as they were, simple use 1, not 0, as the parameter.
	 * @param x The value to divide X by.
	 * @param y The value to divide Y by.
	 * @param z The value to divide Z by.
	 * @return this
	 */
	 ...
	 * @param vector3f The vector to divide this vector by.
	 * @return this
	 */
	 ...
	 * @param vector3f The second vector to calculate distance from.
	...
	/*public float distance(Vector3f vector3f){
		 ...
		 * - (x1 - x2)^2 + (y1 - y2)^2
		 *
		return (float) Math.sqrt(((this.x - vector3f.x) * (this.x - vector3f.x)) + ((this.y - vector3f.y) * (this.y - vector3f.y)));
	}*/
}
